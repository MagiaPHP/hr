...
<table class="table table-striped">
    ...
    <tbody>
        ...
        foreach ($hr_employee_benefits_by_month as $key => $hr_employee_benefits_by_month_item) {
            ...
            echo '<td><a href="index.php?c=contacts&a=hr_employee_worked_days&id=' . $hr_employee_benefits_by_month_item['employee_id'] . '&&month=' . $month . '&year=' . $year . '">' . contacts_formated($hr_employee_benefits_by_month_item['employee_id']) . '</a></td>';
