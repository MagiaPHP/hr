    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <script>
                            function CopyToTextarea(el) {
                                var text = el.textContent,
                                        textarea = document.getElementById('total_sold_<?php echo $prbm->getEmployee_id(); ?>'),
                                        textareaValue = textarea.value,
                                        Regex = new RegExp(text + '\n', 'g'),
                                        textareaValue = textareaValue + ' ' + text + ' ';
                ...
                <code>
                    <a href="#" onclick="CopyToTextarea(this)">( %salary_hour% * %worked_hours% ) - ( %precompte% + %meal_vouchers% + %fine_withdrawal% + %money_advance_bank% + %money_advance_cash% ) + %driver%</a>
                </code>
