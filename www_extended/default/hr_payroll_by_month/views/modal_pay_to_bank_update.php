    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <script>
                            function CopyToTextarea(el) {
                                var text = el.textContent, // get this <a> text
                                        textarea = document.getElementById('pay_to_bank_<?php echo $prbm->getEmployee_id(); ?>'), // textarea id
                ...
                <code>
                    <a href="#" onclick="CopyToTextarea(this)">1900 - %precompte% - %money_advance_bank% - %value_round%</a>
                </code>
