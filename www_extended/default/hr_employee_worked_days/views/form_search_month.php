...
<form class="navbar-form navbar-left" method="get" action="index.php">
    ...
    <div class="form-group">
        ...
        <?php echo (json_decode(_options_option('config_hr_payroll_by_month_fix_date'), true)['fix']) ? " disabled " : ""; ?>
                ...
                >
                    <?php
                    for ($y = hr_employee_worked_days_min_year() ? hr_employee_worked_days_min_year() : date("Y"); $y <= ( hr_employee_worked_days_max_year() ? hr_employee_worked_days_max_year() : date("Y")); $y++) {
