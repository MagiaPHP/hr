...
// http://localhost/factuz/index.php?c=projects&a=hours_worked&id=85
//
...
###############################################################################
    ...
    if (!$error) {
        $lastInsertId = hr_employee_worked_days_add(
                $employee_id, $date, $start_am, $end_am, $lunch, $start_pm, $end_pm, $total_hours, $project_id, $notes, $order_by, $status
        );
    }
}
