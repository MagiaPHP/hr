...
if (!$error) {
    ...
    _options_push("config_hr_fines_categories_show_col_from_table", $data, 'hr_fines_categories');
    ...
    switch ($redi["redi"]) {
        ...
        case 5: // custom
            // ejemplo index.php?c=hr_fines_categories&a=ok_show_col_from_table&redi[redi]=5&redi[c]=contacts&redi[a]=details&redi[params]=id%3D1022
