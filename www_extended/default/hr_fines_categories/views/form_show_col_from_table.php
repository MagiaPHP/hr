...
<form method="post" action="index.php">
    ...
    <table class="table table-bordered">
        ...
        <?php
//            $checked_array = json_decode(_options_option("config_hr_fines_categories_show_col_from_table"), true);
//            foreach (hr_fines_categories_db_col_list_from_table($c) as $th) {
...
//            "button_save",
        ...
        $checked_array = json_decode(_options_option("config_hr_fines_categories_show_col_from_table"), true)['cols'];
